...
public class HybridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infoDirectionTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.google.com/maps?q=hybrid+cafe+about&hotel_occupancy=2&sxsr" +
                        "f=ALeKk03EVH5m4sF1T76MEy1MMvm9mymL4w:1624255984458&gs_lcp=Cgdnd3Mtd2l6EAMyB" +
                        "QghEKABMgUIIRCgAToHCCMQsAMQJzoNCC4QxwEQrwEQsAMQJzoHCAAQRxCwAzoECCMQJzoICC4Qx" +
                        "wEQrwE6BggAEBYQHjoICAAQFhAKEB46BwghEAoQoAE6BgghEA0QFToICAAQCBANEB5Q-hFYny1g" +
                        "6S9oBHACeAGAAYQCiAHiEZIBBTEuNS42mAEAoAEBqgEHZ3dzLXdpesgBCMABAQ&uact=5&um=1&" +
                        "ie=UTF-8&sa=X&ved=2ahUKEwjCqajQiajxAhUsILcAHRYVBJIQ_AUoBHoECAEQBg";
        ...
        infoWebsiteTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.zomato.com/ncr/hybrid-janpath-new-delhi";
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                startActivity(intent);
            }
        });
